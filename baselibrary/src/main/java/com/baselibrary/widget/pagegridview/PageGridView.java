 ...
 * 功能描述：
 */
public class PageGridView<T extends TypeModel> extends FrameLayout {
    ...
    private void initAttrs(Context context, AttributeSet attributeSet) {
        ...
        itemLine = typedArray.getDimensionPixelOffset(R.styleable.PageGridView_itemLine, DEFAULT_VP_PADDING);
        typedArray.recycle();
    }
    ...
    private void initViews(Context context) {
        ...
        layoutParams.height = rows * itemHeight + 2 * itemLine * 2;
        layoutParams.height += vpPadding * 2;
        layoutParams.height += itemLine * rows;
    ...
    public void setData(List<T> data) {
        ...
        for (int i = 0; i < pageCount; i++) {
            ...
            gridView.setVerticalSpacing(itemLine);
            gridView.setBackgroundColor(Color.parseColor("#7CD8E3"));
            gridView.setPadding(itemLine * 2, itemLine * 2, itemLine * 2, itemLine * 2);
            ...
            timer.schedule(new TimerTask() {
                ...
                public void run() {
                    post(new Runnable() {
                        @Override
                        public void run() {
                            if (mViewPager.getCurrentItem() + 1 == mPagerList.size()) {
    ...
    class GridViewAdapter<T extends TypeModel> extends BaseAdapter {
        private List<T> mDatas;
