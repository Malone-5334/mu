package com.baselibrary.widget.materialrefreshlayout;
...
public class MaterialRefreshLayout extends FrameLayout {
    ...
    private final static int SMALL_PROGRESS_SIZE = 40;
    ...
    private void init(Context context, AttributeSet attrs, int defstyleAttr) {
        ...
        if (progressSizeType == 0) {
            progressSize = SMALL_PROGRESS_SIZE;
        } else if (progressSizeType == 2) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (dy > 25 && !canChildScrollUp()) {
                    ...
                    return true;
                } else if (dy < -25 && !canChildScrollDown() && isLoadMore) {
